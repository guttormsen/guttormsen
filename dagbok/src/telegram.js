 ...
 * ikke velte det forfatteren holder på med – blir en melding liggende usendt, er det
...
/** Tar bort «laster»-sirkelen på knappen leseren nettopp trykket. */
export const kvitterTrykk = (env, id, tekst) =>
  kall(env, 'answerCallbackQuery', { callback_query_id: id, text: tekst });

/**
 * Bytter ut knappene med det leseren valgte, så meldingen viser hva som ble
...
/**
 * Skriver om meldingen leseren allerede ser på.
 *
...
/**
 * Henter en fil leseren har sendt boten.
 *
