...
| `lykkeglasset/` | En egen, privat app. Ingen sammenheng med turappen. | Cloudflare Workers, egen adresse |

De to skal ikke blandes. `lykkeglasset/` har sin egen `CLAUDE.md` med reglene
som gjelder der – les den før du gjør noe i den mappa, og la den ellers være.

Jobber du med turappen: `lykkeglasset/` finnes ikke for deg. Den er holdt
